...
class GridModel extends \yii\db\ActiveRecord
{
    ...
    public $dropdownClass          = 'nadzif\base\widgets\Select2';
    public $dropdownOptions        = [];
    public $dropdownItemKey;
    public $datePickerClass        = 'nadzif\base\widgets\DatePicker';
    public $datePickerOptions      = [];
    public $dateRangePickerClass   = 'nadzif\base\widgets\DateRangePicker';
    ...
    public  $actionColumnClass        = 'nadzif\base\components\ActionColumn';
